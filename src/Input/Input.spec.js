...
import inputDriverFactory from './testkit/Input';
import {testkitFactory, createDriverWrapper} from './../test-common';
...
describe('Input', () => {
  ...
  describe('endpadding class', () => {
    it('should have endpadding when error is true', () => {
      const driver = createDriver(<Input error/>);
      expect(driver.hasEndWrapping()).toBeTruthy();
    });
...
describe('testkit', () => {
  it('should exist', () => {
    ...
    const driver = testkitFactory(inputDriverFactory, {wrapper, id});
